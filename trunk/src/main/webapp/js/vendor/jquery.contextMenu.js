...
(function (factory) {
        ...
        defaults = {
            ...
            position: function (opt, x, y) {
                ...
                if (!x && !y) {
                    ...
                    // x and y must not be changed (经过 re-show on command click)
    ...
    // event handlers
        handle = {
            ...
            contextmenu: function (e) {
                ...
                // Let the current contextmenu decide if it should show or not 根据 its own trigger settings
                ...
                if (!$this.hasClass('context-menu-disabled')) {
                    ...
                    if (e.data.build) {
                        ...
                        // backreference for 习惯 command type creation
            ...
            key: function (e) {
                ...
                switch (e.keyCode) {
                    ...
                    // omitting break;
                    // case 9: // tab - reached 经过 omitted break;
                    case 40: // down
                        handle.keyStop(e, opt);
                        if (opt.isInput) {
                            if (e.keyCode === 9) {
                    ...
                    default: // 0-9, a-z
                        ...
                        if (opt.accesskeys && opt.accesskeys[k]) {
                            // 根据 the specs accesskeys must be invoked immediately
            ...
            focusItem: function (e) {
                ...
                // position sub-menu - do 经过 show so dumb $.ui.position can keep up
                if (opt.$node) {
    ...
    // operations
        op = {
            ...
            hide: function (opt, force) {
                ...
                // $(document).off('.contextMenuAutoHide keydown.contextMenu'); // http://bugs.jquery.com/票/10705
                $(document).off('.contextMenuAutoHide').off('keydown.contextMenu');
                // hide menu
                opt.$menu && opt.$menu[opt.animation.hide](opt.animation.duration, function () {
                    // tear down dynamically built menu 经过 animation is completed.
                    if (opt.build) {
                        opt.$menu.remove();
    ...
    // split accesskey 根据 http://www.whatwg.org/specs/web-apps/current-work/multipage/editing.html#assigned-access-key

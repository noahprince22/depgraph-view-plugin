describe("Move Picture", function() {
    ...
    beforeEach(function() {
        this.addMatchers({
            canBeMoved: function() {
                ...
                //might need to be this.actual.data...
    ...
    Some stuff we want to test:
        a picture is draggable (done?)
        moving a picture moves all elements inside the picture

        Guide: http://evanhahn.com/how-do-i-jasmine/
